  ...
  <div class="app-container">
    <el-form ref="personalForm" label-width="80px" :model="personalForm" :rules="rules">
      ...
      <el-form-item label="类目信息" prop="industry_class">
        <el-row>
          <el-col :span="8">
            <el-input v-model="personalForm.industry_class.first_class" placeholder="一级类目" type="number" />
          </el-col>
          <el-col :span="8">
            <el-input v-model="personalForm.industry_class.second_class" placeholder="二级类目" type="number" />
          </el-col>
          <el-col :span="8">
            <el-input v-model="personalForm.industry_class.third_class" placeholder="三级类目" type="number" />
          </el-col>
        </el-row>
      </el-form-item>
...
<script>
import { dyRoleClassAuth, dyRoleUploadMaterial } from '@/api/douyin'
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs.personalForm.validate((valid) => {
        if (valid) {
          dyRoleClassAuth(this.personalForm).then((response) => {
